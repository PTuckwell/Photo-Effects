...
function greyscale() {
    ...
    for (let i = 0; i < data.length; i += 4) {
        ...
        data[i] = grey; //red values
        data[i + 1] = grey; //green values
        data[i + 2] = grey; //blue values
    }
...
function sepia() {
    ...
    for (let i = 0; i < data.length; i += 4) {
        const grey = data[i] * 0.21 + data[i + 1] * 0.71 + data[i + 2] * 0.07
        data[i] = grey + 95; //red values
        data[i + 1] = grey + 58; //green values
        data[i + 2] = grey; //blue values
    }
    ctx.putImageData(imageData, 0, 0)
}
...
function invert() {
    ...
    const data = imageData.data
    for (let i = 0; i < data.length; i += 4) {
        data[i] = 255 - data[i] //red values
        data[i + 1] = 255 - data[i + 1]; //green values
        data[i + 2] = 255 - data[i + 2]; //blue values
    }
    ctx.putImageData(imageData, 0, 0)
}
